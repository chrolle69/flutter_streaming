  ...
  factory StreamModel.fromJson(Map<dynamic, dynamic> data) {
    ...
    try {
      ...
      if (productOffersList != null) {
        productOffersResult = productOffersList
          .where((e) => e != null)
          .map((e) {
      ...
      if (productTypesList != null) {
        productTypesResult = productTypesList
            .where((e) => e != null)
            .map((e) {
              if (e is int) {
...
extension ProductTypeExtension on ProductType {
  static ProductType fromString(String value) {
    return ProductType.values.firstWhere((e) => e.toString().split('.').last == value);
  }
}